...
resourcename="cardealershipsystem"  # lower case, only
resourcegroup="cardealershipsystem_rg"
...
# git clone https://github.com/apilogicserver/cardealershipsystem.git
...
az group create --name cardealershipsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cardealershipsystem_rg --sku S1 --is-linux
az container create --resource-group cardealershipsystem_rg --name cardealershipsystem --image apilogicserver/cardealershipsystem:latest --dns-name-label cardealershipsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cardealershipsystem.westus.azurecontainer.io:5656'
